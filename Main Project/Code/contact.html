...
<body class="bg-gray-100">
    ...
    <header class="bg-teal-900 text-white">
        <div class="container mx-auto flex justify-between items-center py-4 px-6">
            ...
            <nav class="space-x-6">
                ...
                <a class="hover:text-gray-300" href="rooms.html">Rooms</a>
                <a class="hover:text-gray-300" href="facilities.html">Facilities</a>
                <a class="hover:text-gray-300" href="contact.html">Contact</a>
            </nav>
            <button id="openPopup" class="text-white hover:underline">Login/Sign Up</button>
        </div>
    </header>

    <!-- Pop-up Login -->
    <!-- Popup Container - Increased width -->
    <div id="popupContainer" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
      <div class="bg-white rounded-lg shadow-xl w-[500px] p-8 relative"> <!-- Changed w-96 to w-[500px] and increased padding -->
          <button id="closePopup" class="absolute top-4 right-4 text-gray-600 hover:text-gray-900 text-2xl">&times;</button>
          
          <div class="flex flex-col items-center mb-6">
              <img src="Logogreen.png" alt="Boboin.aja logo" class="w-40 h-auto mb-4"> <!-- Adjusted logo size and used actual logo -->
          ...
          <div class="flex justify-center mb-4 border-b">
            ...
            <div id="signin" class="tab-content active">
                ...
                <p class="text-center mt-4 text-sm">
                    ...
                    <a href="#" onclick="showTab('signup')" class="text-green-500 hover:underline">Sign Up</a>
                </p>
            </div>
            ...
            <div id="signup" class="tab-content hidden">
                ...
                <p class="text-center mt-4 text-sm">
                    ...
                    <a href="#" onclick="showTab('signin')" class="text-green-500 hover:underline">Log In</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function showTab(tabId) {
            ...
            // Add active states to selected tab
  ...
  <section class="container mx-auto py-12 px-6">
    ...
    <div class="bg-gray-100 p-6 rounded-lg shadow-md">
      ...
      <p class="text-gray-600 text-sm">Jl. Pancuran 7, Hamlet III Berubahan, Kemutug Lor, Baturaden District, Banyumas
