...
<head>
    ...
    <link rel="stylesheet" href="style1.css"> <!-- Hubungkan file CSS -->
</head>
...
<?php if ($_SERVER["REQUEST_METHOD"] == "POST" && empty($firstNameErr) && empty($emailErr) && empty($phoneNumberErr) && empty($dateOfBirthErr)): ?>
    <h3 class="section-title">Hasil Input</h3>
    <table>
        <tr>
            <th>Field</th>
            <th>Value</th>
